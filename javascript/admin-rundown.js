  ...
  modal({
    ...
    body:
      '<div class="form-grid">'+
        ...
        '<div class="field full"><label>Short description <span class="rd-count" id="rdf-count">0/100</span></label>'+
    ...
    onSave: async function(bg){
      ...
      var payload = { title: title, description: desc || null };

...
function go(name){
  ...
  const fn = {dashboard:loadDashboard, staff:loadStaff, subscribers:loadSubscribers, recruitment:loadRecruitment,
    ...
    startsit:loadStartsit, gamepicks:loadGamePicks, logins:loadLogins, rankings:loadRankings, bets: loadBets, bold_predictions:loadBoldPredictions, rundown:loadRundown}[name];
